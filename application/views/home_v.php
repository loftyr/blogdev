        	...
        	<div class="card-body">
	            <div class="row no-gutters align-items-center">
		            <div href="#" class="col mr-2">
		            	<div class="text-xs font-weight-bold text-primary text-uppercase mb-1">Thread IN</div>
    ...
    <div class="col-xl-3 col-md-6 mb-4">
    	<div class="card border-left-info shadow h-100 py-2">
        	<div class="card-body">
	            <div class="row no-gutters align-items-center">
		            <div href="#" class="col mr-2">
		            	<div class="text-xs font-weight-bold text-primary text-uppercase mb-1">Thread Posting</div>
