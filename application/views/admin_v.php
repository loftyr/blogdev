...
<head>
	...
	<!-- Costum Font -->
	<link rel="stylesheet" href="<?= base_url('plugin/fontawesome-free/css/all.min.css'); ?>">

	<!-- Default Template CSS -->
	<link rel="stylesheet" href="<?= base_url('plugin/sb-admin-2.css'); ?>">
...
<body id="page-top">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
		...
		<li class="nav-item">
        	...
        	<div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
	            ...
	            <h6 class="collapse-header">Thread</h6>
	            <a class="collapse-item" href="?page=loker">Loker</a>
	            <a class="collapse-item" href="?page=syarat">Syarat & Ketentuan</a>
          		</div>
			</div>
		</li>
      	...
      	<div id="content">
	        ...
	        <div class="container-fluid">
			    ...
			    <div class="d-sm-flex align-items-center justify-content-between mb-4">
			   	...
			   	<?php if (@$_GET['page'] == "loker"): ?>
					<?php $this->load->view('loker_v'); ?>
				<?php elseif(@$_GET['page'] == "" || @$_GET['page'] == "home"): ?>
					<?php $this->load->view('home_v'); ?>
				<?php else: ?>
					<?php $this->load->view('not_found_v'); ?>
				<?php endif ?>
  ...
  <a class="scroll-to-top rounded" href="#page-top">
	...
	<?php elseif(@$_GET['page'] == "" || @$_GET['page'] == "home"): ?>
		...
		<!-- Page level custom Home -->
		<script src="<?= base_url('plugin/myChart.js') ?>"></script>
	<?php else: ?>
